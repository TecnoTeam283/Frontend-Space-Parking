      ...
      <ModalDetails isOpen={isOpenDetail}  onRequestClose={handleCloseDetail} closeModal={handleCloseDetail}/>
        ...
        <main id='mainHomeUser'>
          <div className="containerParkings">
            <CardParking showModal={isOpen}  priceParking="800" adressParking="MZ 3 #33 B/la cejita" nameParking="Parqueadero la cejita" urlImage="https://res.cloudinary.com/miguelgo205/image/upload/v1683169573/SpaceParking/Parking-rafiki_rhgxqq.png" />
